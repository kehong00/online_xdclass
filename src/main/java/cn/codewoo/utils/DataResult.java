...
public class DataResult {
    ...
    public static DataResult success(){
        return new DataResult(BaseRespCodeImpl.SUCCESS,null);
    }
    ...
    public static DataResult success(Object data){
        return new DataResult(BaseRespCodeImpl.SUCCESS,data);
    }
    ...
    public static DataResult error(){
        return new DataResult(BaseRespCodeImpl.ERROR,null);
    }
    ...
    public static DataResult error(Object data){
        return new DataResult(BaseRespCodeImpl.ERROR,data);
    }
